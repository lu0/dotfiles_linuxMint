...
# https://github.com/smurphos/nemo_actions_and_cinnamon_scripts/blob/master/.local/bin/opacify_windows.sh
...
GROUP_OPACITY=100              # Unfocussed applications that share a PID with the focussed application
DEFAULT_OPACITY=80            # Any others - e.g unfocused applications.
